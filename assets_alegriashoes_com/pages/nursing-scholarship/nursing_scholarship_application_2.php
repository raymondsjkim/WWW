		...
		<div class="container">
			...
			<!-- 				<select>
				...
				<div class="row">
					...
					<textarea rows="20" cols="100" id="essay" class="required" value="<?php echo $essay?>" name="essay" placeholder="Enter essay here. We recommend writing it in a word processor and pasting it into this field when 
						you are finished to prevent losing your work on accident."/>
						</textarea>
				</div>
				<div class="row">
