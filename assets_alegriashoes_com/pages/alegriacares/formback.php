...
if(isset($_POST['submit'])) {
	...
	//echo $subject;
		...
		//}
		$emailTo[1] = "info@alegriashoes.com";
		...
		$emailTo = "$emailTo[$subject]"; //Put your own email address here info@alegrishoes.com
	...
	<form method="post" action="main.php" id="contactform">
		<div>
            ...
            <select name="subject" id="subject" class="required">
                    ...
                    <option value='3'>Order / Product Warranty Assistance</option>
