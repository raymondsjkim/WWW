<?php
	if($company == "PGL"){
		...
		$condition = "class !='ALG-Z1' AND"; // if BOTH is the company, show both PGL and ALG, except closeouts.
	...
	if(isset($newproducts)){
		$query = "SELECT * FROM $intable WHERE class = 'ALG5' ORDER BY itemNo ASC";
