...
<title>Alegria Dealer Center Access Request</title>  
...
if(isset($_POST['submit'])) {
	...
	//echo $subject;
		...
		//$emailTo[2] = "info@alegriashoes.com";
		//$emailTo[3] = "sales@alegriashoes.com";
		//$emailTo[4] = "info@alegriashoes.com";
		
		$subj[1] = "Dealer Center Access Request";
		//$subj[2] = "Product Inquiry";
		//$subj[3] = "Order Assistance";
		//$subj[4] = "Feedback";
		
		$emailTo = "$emailTo[1]"; //Put your own email address here info@alegrishoes.com
...
$(document).ready(function(){
	...
	$("#contactform").validate({
		...
		messages: {
			...
			biz: "Please enter your Business Name",
...
<div id="Container">
		...
		<div id="Outer">
            ...
            <div id="Wrapper">
                <div class="contentRow">
                    <div class="areaHeader" >Dealer Center Access Request Form</div>
                    <p>Please fill out the following form to provide us your Information, Alegria Customer ID and Business name to help us to process your reqeust of accessing the Dealer Center. We need to have your Alegria Customer ID in order to verify your request, we will process your request ASAP during our normal business hours, M-F 9am to 5pm. Thank you. 
                </div>
	...
	<?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
		...
		Thank you <strong><?php echo $name;?></strong> for submitting your request! We will be in touch with you shortly.</p>
	<?php } ?>

	<form method="post" action="access-request.php" id="contactform">
		<!-- div>
        ...
        <div>
		    <label for="occupation"><strong>Alegria Customer ID *</strong></label>
			<input type="text" size="50" name="customerID" id="customerID" value="<?php echo $customerID?>" class="required" /> <br/><span class="HelpText">i.e. A9999</span>
		</div>
        <div>
			<label for="email"><strong>Business Name *</strong></label>
